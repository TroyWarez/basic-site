...
const OrderForm = (): JSX.Element => {
    ...
    const StateList: SelectMenuOption[] = [
      ...
      {value: ["K", "L", "M", "N", "P"], displayValue: 'Ontario'}, //Postal Districts K, L, M, N, P
      {value: ["G", "H", "J"], displayValue: 'Quebec'},
      {value: ["B"], displayValue: 'Nova Scotia'},
      {value: ["E"], displayValue: 'New Brunswick'},
      {value: ["R"], displayValue: 'Manitoba'},
      {value: ["V"], displayValue: 'British Columbia'},
      {value: ["C"], displayValue: 'Prince Edward Island'},
      {value: ["T"], displayValue: 'Alberta'},
      {value: ["A"], displayValue: 'Newfoundland and Labrador'},
      {value: ["Y"], displayValue: 'Yukon'},
      {value: ["X"], displayValue: 'Northwest Territories'},
      {value: ["X"], displayValue: 'Nunavut'},
      ];
    return (
      <div>
      ...
      <div className={CheckoutClasses.CheckoutCartTitle}>
        ...
        <div className={classes.inputSplitContainer}>
                <FormInput className={classes.inputfirstlast} type="text" pattern="[A-Za-z]+" minlength={1} maxlength={50} name="name" label="First Name" title="First Name" onInput={onInput} error_message='This is a mandatory field' message='' validation_message='This entry contains invalid characters. Please try again' tooShort_message='' required={true} autoComplete="given-name" />
