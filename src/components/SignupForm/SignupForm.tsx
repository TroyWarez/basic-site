...
const SignupForm = () : JSX.Element => {
  ...
  return (
    ...
    <FormInput type="text" pattern="[A-Za-z0-9]+" name="username"  id="username" label="Username" error_message='Invalid Username' message='' tooShort_message='This username is too short' validation_message='Invalid Username' title="Username" required={true} minlength={2} maxLength={20}/>
    ...
    <FormInput 
      ...
      disabled
      value="Sign Up"/>
    <b>Already have an account? Click 
      <Link to='/login' className={CartClasses.AltText}>here</Link>
    to login.</b>
    </form>
    </>
  )
